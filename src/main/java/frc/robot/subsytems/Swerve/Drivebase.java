...
public class Drivebase extends SubsystemBase {
  ...
  public void periodic() {
    ...
    odometry.update(Rotation2d.fromDegrees(gyro.getAngle()),
        new SwerveModulePosition[] { frontLeft.getPosition(), backLeft.getPosition(),  frontRight.getPosition(), backRight.getPosition()}
        );
  }
  ...
  public void resetOdometry(Pose2d pose) {
    odometry.resetPosition(
        ...
        new SwerveModulePosition[]{ frontLeft.getPosition(), backLeft.getPosition(), frontRight.getPosition(), backRight.getPosition() }, pose);
  }
